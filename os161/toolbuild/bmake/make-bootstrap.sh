...
srcdir=/home/parallels/os161/toolbuild/bmake

DEFAULT_SYS_PATH="/home/parallels/os161/tools/share/mk"
...
CC="gcc"
CFLAGS="-g -O2 -fcommon -I. -I${srcdir} -DHAVE_CONFIG_H  -I/home/parallels/os161/toolbuild/bmake/missing -DNEED_HOST_CDEFS_H -DMAKE_NATIVE ${XDEFS}"

MAKE_VERSION=`sed -n '/^MAKE_VERSION=/s,.*=[^0-9]*,,p' Makefile`

MDEFS="-DMAKE_VERSION=\"$MAKE_VERSION\" \
-DMACHINE=\"linux6\" -DMACHINE_ARCH=\"aarch64\" \
